  ...
  <div style="overflow:scroll;">
	 ...
	 %>
		  	...
		  	<tr>
		    	...
		    	<td><a href="DeleteServlet?id=<%=book.getId()%>" > <button >DELETE</button></a>
		    	<a href="update.jsp?id=<%=book.getId()%>&book_name=<%=book.getBook_name()%>&book_author=<%=book.getBook_author()%>"><button>UPDATE</button></a>
		    	 </td>
		  	</tr>
	 		<%} %>
  		<%} %>
